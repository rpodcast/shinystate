...
* Fixed race condition where multiple concurrent bookmark saves could result in data loss
* Fixed `restore()` method to properly reconstruct full URLs from stored query string portions
