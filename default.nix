...
let
 ...
 rpkgs = builtins.attrValues {
  inherit (pkgs.rPackages) shiny fs languageserver pins archive s3fs DT DBI RSQLite lubridate pool dplyr dbplyr devtools testthat arrow Microsoft365R paws_storage sodium zip AzureStor shinytest2;
};
